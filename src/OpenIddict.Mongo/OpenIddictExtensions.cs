...
namespace Microsoft.Extensions.DependencyInjection
{
    public static class OpenIddictExtensions
    {
        ...
        {
            return builder.AddMongoCoreStores<IMongoContext>();
        }
        ...
        public static IServiceCollection AddMongoDBContext<TContext, TConn>(this IServiceCollection services)
            ...
            where TConn: class, IMongoConnection
        {
            services.AddScoped<IMongoConnection, TConn>();
        ...
        {
            return services.AddMongoDBContext<MongoContext, MongoConnection>();
        }
