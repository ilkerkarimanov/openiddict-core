...
namespace OpenIddict.Mongo.Stores
{
    ...
    {
        public OpenIddictApplicationStore(TContext context) : base(context) { }
    }
    /// <summary>
    /// Provides methods allowing to manage the applications stored in a database.
    /// </summary>
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        /// </returns>
        public virtual async Task<TApplication> CreateAsync(TApplication application, CancellationToken cancellationToken)
        {
            if (application == null)
            {
        ...
        /// </returns>
        public virtual Task<string> GetClientIdAsync(TApplication application, CancellationToken cancellationToken)
        {
            if (application == null)
            {
                throw new ArgumentNullException(nameof(application));
