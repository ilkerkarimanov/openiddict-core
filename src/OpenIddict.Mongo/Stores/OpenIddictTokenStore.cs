...
namespace OpenIddict.Mongo.Stores
{
    ...
    {
        public OpenIddictTokenStore(TContext context) : base(context) { }
    }
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        /// </returns>
        public virtual async Task<TToken> CreateAsync(TToken token, CancellationToken cancellationToken)
        {
            if (token == null)
            {
        ...
        /// A <see cref="Task"/> that can be used to monitor the asynchronous operation, whose result returns the token.
        /// </returns>
        public virtual Task<TToken> CreateAsync(string type, string subject, CancellationToken cancellationToken)
        {
        ...
        /// </returns>
        public virtual Task<string> GetIdAsync(TToken token, CancellationToken cancellationToken)
        {
            if (token == null)
            {
                throw new ArgumentNullException(nameof(token));
        ...
        /// </returns>
        public virtual Task<string> GetTokenTypeAsync(TToken token, CancellationToken cancellationToken)
        {
            if (token == null)
            {
                throw new ArgumentNullException(nameof(token));
        ...
        public virtual async Task RevokeAsync(TToken token, CancellationToken cancellationToken)
        {
            if (token == null)
            {
                throw new ArgumentNullException(nameof(token));
        ...
        /// A <see cref="Task"/> that can be used to monitor the asynchronous operation.
        /// </returns>
        public virtual async Task SetAuthorizationAsync(TToken token, string identifier, CancellationToken cancellationToken)
        {
            if (token == null)
            {
                throw new ArgumentNullException(nameof(token));
        ...
        /// A <see cref="Task"/> that can be used to monitor the asynchronous operation.
        /// </returns>
        public virtual async Task SetClientAsync(TToken token, string identifier, CancellationToken cancellationToken)
        {
            if (token == null)
            {
                throw new ArgumentNullException(nameof(token));
