...
namespace OpenIddict.Mongo.Stores
{
    ...
    {
        public OpenIddictAuthorizationStore(TContext context) : base(context) { }
    }
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        /// </returns>
        public virtual async Task<TAuthorization> CreateAsync(TAuthorization authorization, CancellationToken cancellationToken)
        {
            ...
            await Authorizations.InsertOneAsync(authorization);
        ...
        public virtual Task<TAuthorization> FindAsync(string subject, string client, CancellationToken cancellationToken)
        {
            ...
            var filter = Builders<TAuthorization>.Filter.Eq(s => s.ApplicationId, key) &
                Builders<TAuthorization>.Filter.Eq(s => s.Subject, subject);

            return Authorizations.Find(filter).FirstOrDefaultAsync();
        }
        ...
        public virtual Task<TAuthorization> FindByIdAsync(string identifier, CancellationToken cancellationToken)
        {
            ...
            return Authorizations.Find(filter).SingleOrDefaultAsync();
        }
        ...
        /// </returns>
        public virtual Task<string> GetIdAsync(TAuthorization authorization, CancellationToken cancellationToken)
        {
            if (authorization == null)
            {
                throw new ArgumentNullException(nameof(authorization));
        ...
        /// </returns>
        public virtual Task<string> GetSubjectAsync(TAuthorization authorization, CancellationToken cancellationToken)
        {
            if (authorization == null)
            {
                throw new ArgumentNullException(nameof(authorization));
